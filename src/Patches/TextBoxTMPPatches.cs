...
{
    private const int HandlingId = 30019;
    ...
    public static void Postfix(TextBoxTMP __instance)
    {
        ...
        catch (Exception ex) { ErrorReporter.Report(ex, HandlingId, "TextBoxTMP_Update.Postfix: clipboard shortcuts"); }
    }
}
...
public static class TextBoxTMP_IsCharAllowed
{
    ...
    public static bool Prefix(TextBoxTMP __instance, ref bool __result)
    {
        ...
        catch (Exception ex) { ErrorReporter.Report(ex, HandlingId, "TextBoxTMP_IsCharAllowed.Prefix: validate char"); return true; }
    }
}
